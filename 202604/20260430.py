...
class Solution:
    ...
    Each cell contributes a specific score and incurs an associated cost, according to
    their cell values:
    ...
    * 2: adds 2 to your score and costs 1. \u200b\u200b\u200b\u200b\u200b\u200b\u200b
    ...
    Return the **maximum** score achievable without exceeding a total cost of `k`, or -1
