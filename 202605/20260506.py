...
class Solution:
    ...
    You are given an `m x n` matrix of characters `box_grid` representing a side-view of
    ...
    * Empty `'.'`
    ...
    It is **guaranteed** that each stone in `box_grid` rests on an obstacle, another
